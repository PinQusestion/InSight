    ...
    <div className="min-h-screen bg-[#08080c] flex relative overflow-hidden">
      ...
      >
        ...
        <Link href="/" className="flex items-center gap-3 w-fit group">
          <motion.div 
            className="w-12 h-12 bg-linear-to-br from-cyan-400 to-cyan-600 rounded-lg flex items-center justify-center group-hover:shadow-lg group-hover:shadow-cyan-500/50 transition-all"
            ...
            {step === 1 ? (
              ...
              >
                ...
                >
                  ...
                  <p className="text-gray-400 text-lg">Join thousands transforming their inbox</p>
                </motion.div>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  >
                    ...
                    <div className="relative group">
                      <User className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-500 group-focus-within:text-cyan-400 transition-colors duration-200" />
                      <input
                        type="text"
                        value={name}
                ...
                >
                  <Link href="/login">
                    <motion.button
                      whileHover={{ scale: 1.02 }}
                      whileTap={{ scale: 0.98 }}
                      className="flex items-center justify-center gap-2 px-8 py-3 bg-cyan-500 hover:bg-cyan-600 text-black font-semibold rounded-lg mx-auto transition-all"
                    >
                      Continue to login
                    </motion.button>
                  </Link>
